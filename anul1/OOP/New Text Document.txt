...
friend void afisare_electronice(int x, referinta **&v,char *a);
   virtual bool is_carte(){return false;};
   virtual bool is_articol(){return false;};
   virtual bool is_web(){return false;};
   int get_an(){return an_publicare;};
    referinta()
    {
...
while (1)
{
    ...
    if(b=='y')
    {
        ...
        switch(x)
        {
            case 0: afisare_totala(contor,vptr);
            break;
            case 1: int x;
            cin>>x;
