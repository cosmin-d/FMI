...
public:
    ...
    graf_complet(int x, int y,int z)   //constructor cu parametri care va apela constructorul clasei de baza
        :graf(x,y,z) {}
...
{public:
    graf_turneu(int x, int y,int z)   //constructor cu parametri care va apela constructorul clasei de baza
        :graf_complet(x,y,z),graf_antisimetric(x,y,z){ };
